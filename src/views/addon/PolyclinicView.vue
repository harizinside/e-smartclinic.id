...
import Polyclinic from './component/VPolyclinic.vue'
import JsonData from '@/utils/poli.json'
...
const columnHeader = ref<IColumnHeader[]>([
  ...
  { name: 'Kategori', type: 'label' },
  { name: 'Status', type: 'label' },
  { name: 'Rilis Pada', type: 'label' },
...
const navs = ref<INavigation[]>([
  ...
  { name: 'Polyclinic', link: '/add-on/polyclinic', active: true }
])
...
useHead({
  title: 'Polyclinic | e-Smart Clinic'
})
</script>
