    ...
    <div class="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div class="sm:mx-auto sm:w-full sm:max-w-md pt-4">
        ...
        <p class="text-xs font-medium text-center text-gray-500">
          Jika kata sandi anda cocok dengan data kami, kami akan kirimkan link perubahan sandi
        </p>
      </div>
            ...
            <div>
              <button
                ...
                <VIcons
                  v-if="isLoading"
                  :name="'spinner-circle'" />
                <span v-else>Kirim reet sandi</span>
              </button>
            </div>
          </form>
...
useHead({
  title: 'Forgot Password | e-Smart Clinic',
  bodyAttrs: {
    class: 'h-full'
  },
  htmlAttrs: {
